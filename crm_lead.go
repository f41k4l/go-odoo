...
type CrmLead struct {
	...
	DaysExceedingClosing            *Float      `xmlrpc:"days_exceeding_closing,omitempty"`
	DaysToConvert                   *Float      `xmlrpc:"days_to_convert,omitempty"`
	...
	VisitorSessionsCount            *Int        `xmlrpc:"visitor_sessions_count,omitempty"`
